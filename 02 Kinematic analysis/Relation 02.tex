...
This implies that the workspace is covering some points in which the geometrical constraints are violated. This can be easily proven using the solution of the inverse kinematics (see Section \ref{s:Inverse-position} evaluated at any point in the obtained workspace and observing that its representation shows a visible violation of such limits.
