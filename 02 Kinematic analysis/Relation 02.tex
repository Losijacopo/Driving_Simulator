...
\begin{multline}
  L_e = 2*\sqrt{L2_^2-(frac{H_2-H_4}{2}-H1+H4)^2}+\\
  + Q_3*\sin(\alpha_4)) + L_5
\end{multline}
...
In this Section the three workspaces regarding the 2D-system are obtained. Before doing so, some important observations must be done.
