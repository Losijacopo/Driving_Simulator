...
At the end, these experimental data were elaborated in Matlab and then, merging both the parameters from the catalogues and the experimental ones, it was created a final table that collects the parameters that will be used for the developing of this project. 
\section{Indexes}
Starting from the above mentioned parameters, performance indexes have been identified and divided in three main groups, two of them are shown in Table \ref{t:SystemRequirements1} and in Table \ref{t:SystemRequirements2}.
\begin{table}[h]
\centering
