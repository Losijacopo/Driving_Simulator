...
To make the correct choice literature have been consulted and physical tests have been carried out.
...
Starting from the above mentioned parameters, performance indexes have been identified and divided in three main groups: kinematics, dynamics and control.
Moreover, a priority coefficient (P) has been assigned to each index.

The general reasoning behind the definition of the kinematics indexes is based on the hypothesis that a good and uniform behaviour in the correlation between engineering parameters has a bigger impact on the performance of the system than the parameters themselves seen as stand alone.
...
\end{itemize}
Cross planes dynamics requirements have not been assigned in this initial stage.
